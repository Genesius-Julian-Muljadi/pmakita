...
export function Footer() {
  ...
  return (
    <footer
      ...
      id="global-footer"
    >
      <div className="container grid grid-cols-2 lg:grid-cols-4 grid-rows-2 lg:grid-rows-1 gap-y-4 gap-x-2 sm:gap-x-4 md:gap-x-6 lg:gap-x-8 xl:gap-x-10 2xl:gap-x-20 *:w-44 sm:*:w-52 justify-items-center *:border *:border-red-500">
